...
PLASMIC.registerComponent(AllStoriesList, {
  ...
  props: {
    ...
    toggleAlign: { type: "choice", options: ["left", "center", "right"], defaultValue: "left", displayName: "Toggle alignment" },
    showCard: { type: "boolean", defaultValue: false, displayName: "Show list card", description: "Show the opened list on a soft rounded card (readable over photos)." },
    panelColor: { type: "color", defaultValue: "rgba(255, 255, 255, 0.08)", displayName: "Card color", section: "Colors", description: "Used when 'Show list card' is on. Default is a soft see-through white for dark backgrounds." },
